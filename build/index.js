...
var ThaiSmartcardReader = function (_Component) {
  _inherits(ThaiSmartcardReader, _Component);

  function ThaiSmartcardReader() {
    var _ref;

    var _temp, _this, _ret;

    _classCallCheck(this, ThaiSmartcardReader);
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ThaiSmartcardReader.__proto__ || Object.getPrototypeOf(ThaiSmartcardReader)).call.apply(_ref, [this].concat(args))), _this), _this.pluginLoaded = function () {
      ...
      var that = _this;
      setTimeout(function () {
        return that.initCard(reader);
      }, 10);
    }, _this.cardRemoved = function () {
      console.log('card removed!');
      _this.props.onChange(null);
    }, _this.hex2string = function (hexx) {
      var tempHexx = hexx;
      if (tempHexx.length > 4) tempHexx = tempHexx.slice(0, -4);
      var patt = /^[a-zA-Z0-9&@.$%\-,():`# \/]+$/;
      var hex = tempHexx.toString();
      var str = '';
      var tmp = '';
      ...
      str = str.replace(/#/g, ' ');
      return str;
    }, _this.initCard = function (reader) {
      ...
      try {
        ...
        person.citizenId = _this.hex2string(resp);

        // Person Info
        apdu = '80B000110200D1';
        resp = reader.transcieve(apdu);
        tmp = _this.hex2string(resp);
  ...
  _createClass(ThaiSmartcardReader, [{
    ...
    key: 'addEvent',
    value: function addEvent(obj, name, func) {
      if (obj.attachEvent) {
...
exports.default = ThaiSmartcardReader;
